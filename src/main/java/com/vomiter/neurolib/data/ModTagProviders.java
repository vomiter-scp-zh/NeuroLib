...
import com.vomiter.neurolib.Helpers;
...
public class ModTagProviders {
    ...
    class BlockTags extends BlockTagsProvider{
        ...
        public BlockTags() {
            super(output, lookupProvider, NeuroLib.MOD_ID, helper);
        }
    ...
    class ItemTags extends ItemTagsProvider {
        public ItemTags(BlockTags blockTags) {
            super(output, lookupProvider, blockTags.contentsGetter(), NeuroLib.MOD_ID, helper);
        }
